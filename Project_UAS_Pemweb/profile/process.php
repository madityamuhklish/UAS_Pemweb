...
if ($action === 'update_profile') {
    ...
    if (!empty($_FILES['photo']['name'])) {
        // CATATAN VERCEL: filesystem di Vercel bersifat read-only & sementara,
        // jadi file yang di-upload di sini TIDAK akan tersimpan permanen kalau
        // di-deploy ke Vercel (akan hilang saat function restart/redeploy).
        // Untuk hosting biasa (XAMPP/InfinityFree/cPanel) fitur ini normal.
