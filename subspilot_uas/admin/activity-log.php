...
$todayCount = $conn->query("SELECT COUNT(*) FROM activity_logs WHERE DATE(created_at) = CURRENT_DATE")->fetchColumn();
$weekCount = $conn->query("SELECT COUNT(*) FROM activity_logs WHERE created_at >= (CURRENT_DATE - INTERVAL '7 days')")->fetchColumn();
